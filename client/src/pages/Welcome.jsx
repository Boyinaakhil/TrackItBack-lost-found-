    ...
    <div className="min-h-screen flex flex-col justify-between bg-gradient-to-br from-blue-50 to-blue-100">
      <header className="flex justify-between items-center p-6 bg-white shadow-md">
        ...
        <div className="space-x-4">
          ...
          <Link to="/chat" className="text-blue-700 hover:underline">Chat</Link>
          <Link to="/notifications" className="text-blue-700 hover:underline">Notifications</Link>
        </div>
      </header>
      ...
      <footer className="bg-white p-6 shadow-inner text-center">
